...
export const brandProductPreset: { dog: BrandProducts; cat: BrandProducts } = {
  dog: {
    royal_canin: [
      ...
      { name: "처방식 - 하이포알레르기 + 세타이어티", kcal: 2.85 },
      { name: "처방식 - 하이포알레르기 + 세타이어티 스몰독", kcal: 2.59 },
      { name: "처방식 - 유리너리 S/O + 세타이어티 스몰독", kcal: 2.90 },
      { name: "처방식 - 유리너리 S/O + 하이포알레르기 스몰독", kcal: 3.48 },
      { name: "처방식 - 레날 + 하이포알레르기 스몰독", kcal: 3.99 },
      { name: "처방식 - 가스트로인테스티널 로우팻 하이포알레르기", kcal: 3.28 },
  ...
  cat: {
    royal_canin: [
      ...
      {name: "처방식 - 뉴터드 새티어티 밸런스 (중성화)", kcal: 3.35},
